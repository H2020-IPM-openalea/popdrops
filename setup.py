...
# * name is the full name (e.g., Alinea.popdrops) whereas pkg_name is only 'popdrops'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['popdrops = alinea.popdrops_wralea' if has_project else 'popdrops = popdrops_wralea' ],
        #'console_scripts': [
